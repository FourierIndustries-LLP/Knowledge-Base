...
![arduinoPot](assets/arduinoPot.png)

Potentiometers are used frequently and commonly on electronic devices. A simple example would be the volume knob on speakers, or the light dimmers in your houses!

**[More on Potentiometers](https://www.electronics-tutorials.ws/resistor/potentiometer.html)**

This is the potentiometer that we will be using in this tutorial:

![arduinoPot1](assets/arduinoPot1.jpg)
...
![arduinoPot2](assets/arduinoPot2.png)
...
![arduinoPot3](assets/arduinoPot3.png)

After you are done with the circuit and code, simply run the simulation and open the serial monitor. As you twist the knob of the potentiometer, you should see the number change from 0 to 1023. Why this specific number? Well... Inside the SSTuino's chip, there is an Analog to Digital Converter, also known as ADC that has a resolution of 10 bits. The higher the resolution, the more precise the measurement is. If you use your calculator and then type in **2 to the power of 10** you will get 1024, which is the number of reading that you will get.
...
Since we have managed to get a reading from an analog pin from the SSTuino, we are going to make use of the reading to alter the blinking speed of an LED. We are going to first fire up TinkerCAD and edit the circuit to something like this: 

![arduinoPot4](assets/arduinoPot4.png)
...
![arduinoPot5](assets/arduinoPot5.png)
...
![arduinoPot7](assets/arduinoPot7.mp4)
...
![arduinoPot6](assets/arduinoPot6.png)
...
![arduinoPot10](assets/arduinoPot10.png)
...
![arduinoPot11](assets/arduinoPot11.png)
...
![arduinoPot12](assets/arduinoPot12.png)